export const Bio = {
  ...
  facebook: "https://www.facebook.com/itsdavidmandal/",
};
...
export const experiences = [
  {
    ...
    company: "WebPoint",
    date: "",
    desc: "Developing an admin and user login page for repair submissions. Building a user interface using React for seamless user experience.Implementing backend services with Express and Node.js for robust server-side logic.Managing data with MySQL and integrating Prisma for efficient database operations.Ensuring secure and efficient handling of user and admin data.Collaborating with the development team to enhance application features and performance.Troubleshooting and debugging to ensure smooth functionality.",
    skills: [
      "ReactJS",
      "NodeJs",
      "Prisma",
  ...
  },
  {
    ...
    role: "S5 BuildSpace Nights and Weekends Participant",
    company: "BuildSpace",
    date: "Jun 2024 - July 2024",
    desc: "As a participant in Buildspace's Nights and Weekends program, I am diving into the world of full-stack development, working on projects outside of regular working hours. This program is designed for driven individuals who are passionate to transform their ideas into a reality.Through Buildspace, I am building 10 MERN stack projects as a part of my MERN mastery, seld development project.",
    skills: [
      "MERN stack"
    ],
  ...
  },
  {
    ...
    role: "Proposed General Member",
    company: "Rotaract Club of Rajdhani",
  ...
  // },
  {
    ...
    desc: "- Participated in a virtual internship program focused on developing python web apps .Gained exposure to advanced python and Flask.Built an expense tracking python web app.Left the internship after realizing it was not aligned with my professional goals and priorities.",
    skills: [
      "Python",
      "Flask"
    ],
...
export const education = [
  {
    id: 0,
    // img: "https://drive.google.com/file/d/1I9C8_QDNMG6lNcE1SF1qeKCF6Ss_gRA4/view?usp=drive_link",
  ...
  },
  {
    ...
    school: "Model Multiple College",
    date: "Jul 2021 - May 2023",
    grade: "3.2 GPA",
    desc: "I completed my class 12 high school education at Model Multiple College,Janakpur , where I studied Science with Biology and Social Studies. I was among the top 10 students of grade 11. Along with helping conduct and participate in the first science exhibition of the college , I also participated in an environmental pollution pilot survey around Janaki Temple and helped analyse the data",
    degree: "Plus 2, Science with Biology and Social Studies",
  },
  {
    id: 2,
    // img: "https://firebasestorage.googleapis.com/v0/b/flexi-coding.appspot.com/o/methodist.png?alt=media&token=018a1b18-e2dd-4f34-8855-cff1b6b69fd3",
    school: "Siddhartha Shishu Sadan , Jankpurdham",
    date: "2021",
    grade: "3.6",
    desc: "I completed my class 10 education at Siddhartha Shishu Sadan , Jankpurdham, where I studied Science with Health Education and was the winner of an intra chess competition",
